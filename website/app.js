/* Global Variables */
// const baseURL = 'http://api.openweathermap.org/data/2.5/forecast?id=524901?';
let baseURL = 'http://api.openweathermap.org/data/2.5/forecast?zip=';
let apiKey = '&appid=562674457583c1acb4d4f565094d8ab3';
...
const updateEl = async () => {
    ...
    try {
        ...
        document.getElementById('date').innerHTML = `Date: ${allMyData[0].date}`;
        document.getElementById('temp').innerHTML = `Temperature: ${allMyData[0].temp}`;
        document.getElementById('content').innerHTML = `I feel like: ${allMyData[0].content}`;
